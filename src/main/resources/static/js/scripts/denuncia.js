...
function save(bandera) {
    ...
    const registro = {
        ...
        telefonoCiudadano: $("#telefonoCiudadano").val(),
        ...
        .done((data) => {
            ...
            if (data.ok) {
                $.each(data.body, (index, denuncia) => {
                    ...
                    t.row.add([botonera, denuncia.id, denuncia.titulo, denuncia.descripcion,denuncia.ubicacion,denuncia.estado,denuncia.ciudadano,denuncia.telefonoCiudadano,denuncia.fechaRegistro]);
                });
                t.draw(false);
            } else {
    ...
    ajaxRequest("GET", `${url}/${id}`)
        .done((data) => {
            if (data.ok) {
                ...
                $("#telefonoCiudadano").val(data.body.telefonoCiudadano);
                $("#fechaRegistro").val(data.body.fechaRegistro);
